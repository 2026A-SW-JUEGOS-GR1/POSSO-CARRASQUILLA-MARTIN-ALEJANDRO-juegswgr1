...
export default class Player extends Phaser.Physics.Arcade.Sprite {
  ...
  constructor(scene, x, y, options) {
    ...
    this.jumpsUsed = 0;
    /** true mientras el doble salto ya se usó en este vuelo (se limpia al aterrizar). */
  ...
  handleJump(time, input, onFloor) {
    ...
    const canDoubleJump =
      this.enableDoubleJump && !this.hasDoubleJumped && this.doubleJumpCooldown.use(time);
